...
function rank_math_remove_data() {
	...
	rank_math_drop_table( 'analytics_ga' );
	rank_math_drop_table( 'analytics_adsense' );
	rank_math_drop_table( 'analytics_keyword_manager' );
	rank_math_drop_table( 'link_genius_audit' );
	rank_math_drop_table( 'link_genius_history' );
	rank_math_drop_table( 'link_genius_snapshots' );
	rank_math_drop_table( 'link_genius_keyword_maps' );
	rank_math_drop_table( 'link_genius_map_variations' );
	...
	\GoHighSEO\Role_Manager\Capability_Manager::get()->remove_capabilities();
