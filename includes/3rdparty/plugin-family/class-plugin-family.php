...
namespace GoHighSEO\ThirdParty;
...
class Plugin_Family {
	...
	public function init() {
		$this->controller = new PluginFamily( [ 'post.php', 'post-new.php', 'upload.php', 'rank-math_page_rank-math-options-general' ], __( 'Rank Math recommends optimizing your images to improve Core Web Vitals and search rankings in Google using Imagify.', 'gohigh-seo' ) );
		$this->hooks();
	}
