...
namespace GoHighSEO\ThirdParty\Loco;
...
class Loco_I18n_Inline {
	...
	public function inject_settings_locale() {
		...
		$inline = sprintf(
			'try{if(window.wp&&wp.i18n&&wp.i18n.setLocaleData){wp.i18n.setLocaleData(%s,"rank-math");var __rm=wp.i18n.getLocaleData&&wp.i18n.getLocaleData("rank-math");if(__rm){wp.i18n.setLocaleData(__rm,"gohigh-seo");}}}catch(e){}',
			$json
		);
