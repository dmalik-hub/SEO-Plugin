...
class Common {
	...
	public function add_json_data( $values ) {
		...
		if ( ! Helper::is_site_connected() ) {
			...
			$values['trendsUpgradeLabel'] = esc_html__( 'Activate now', 'gohigh-seo' );
		}
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'rank-math-gallery-analysis', RANK_MATH_PRO_URL . 'assets/admin/js/product-analysis.js', [ 'rank-math-editor' ], rank_math()->version, true );
	}
