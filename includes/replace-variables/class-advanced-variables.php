...
class Advanced_Variables extends Author_Variables {
	...
	public function setup_advanced_variables() {
		...
		$this->register_replacement(
			'id',
			[
				'name'        => esc_html__( 'Post ID', 'gohigh-seo' ),
				'description' => esc_html__( 'ID of the current post/page', 'gohigh-seo' ),
				'variable'    => 'id',
				'example'     => ! empty( $post ) ? $post->ID : __( 'Post ID', 'gohigh-seo' ),
			],
			[ $this, 'get_id' ]
		);
		...
		$this->register_replacement(
			'focuskw',
			[
				'name'        => esc_html__( 'Focus Keyword', 'gohigh-seo' ),
				'description' => esc_html__( 'Focus Keyword of the current post', 'gohigh-seo' ),
				'variable'    => 'focuskw',
		...
		$this->register_replacement(
			'keywords',
			[
				'name'        => esc_html__( 'Focus Keywords', 'gohigh-seo' ),
				'description' => esc_html__( 'Focus Keywords of the current post', 'gohigh-seo' ),
				'variable'    => 'keywords',
		...
		$this->register_replacement(
			'customfield',
			[
				'name'        => esc_html__( 'Custom Field (advanced)', 'gohigh-seo' ),
				'description' => esc_html__( 'Custom field value.', 'gohigh-seo' ),
				'variable'    => 'customfield(field-name)',
				'example'     => esc_html__( 'Custom field value', 'gohigh-seo' ),
				'nocache'     => true,
			],
	...
	private function setup_paging_variables() {
		$this->register_replacement(
			...
			[
				...
				'description' => esc_html__( 'Page number with context (i.e. page 2 of 4). Only displayed on page 2 and above.', 'gohigh-seo' ),
				'variable'    => 'page',
				'example'     => ' page 2 of 4',
			],
			[ $this, 'get_page' ]
		...
		$this->register_replacement(
			'pagenumber',
			[
				'name'        => esc_html__( 'Page Number', 'gohigh-seo' ),
				'description' => esc_html__( 'Current page number', 'gohigh-seo' ),
				'variable'    => 'pagenumber',
				'example'     => '4',
			],
			[ $this, 'get_pagenumber' ]
		...
		$this->register_replacement(
			'pagetotal',
			[
				'name'        => esc_html__( 'Max Pages', 'gohigh-seo' ),
				'description' => esc_html__( 'Max pages number', 'gohigh-seo' ),
				'variable'    => 'pagetotal',
				'example'     => '4',
			],
			[ $this, 'get_pagetotal' ]
	...
	private function setup_post_types_variables() {
		$this->register_replacement(
			'pt_single',
			[
				'name'        => esc_html__( 'Post Type Name Singular', 'gohigh-seo' ),
				'description' => esc_html__( 'Name of current post type (singular)', 'gohigh-seo' ),
				'variable'    => 'pt_single',
				'example'     => esc_html__( 'Product', 'gohigh-seo' ),
			],
		...
		$this->register_replacement(
			'pt_plural',
			[
				'name'        => esc_html__( 'Post Type Name Plural', 'gohigh-seo' ),
				'description' => esc_html__( 'Name of current post type (plural)', 'gohigh-seo' ),
				'variable'    => 'pt_plural',
				'example'     => esc_html__( 'Products', 'gohigh-seo' ),
			],
	...
	public function get_page() {
		...
		if ( $max > 1 && $page > 1 ) {
			...
			return sprintf( $sep . ' ' . __( 'Page %1$d of %2$d', 'gohigh-seo' ), $page, $max );
		}
