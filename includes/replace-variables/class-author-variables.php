...
class Author_Variables extends Term_Variables {
	...
	public function setup_author_variables() {
		...
		$this->register_replacement(
			'userid',
			[
				'name'        => esc_html__( 'Author ID', 'gohigh-seo' ),
				'description' => esc_html__( 'Author\'s user ID of the current post, page or author archive.', 'gohigh-seo' ),
				'variable'    => 'userid',
		...
		$this->register_replacement(
			'name',
			[
				'name'        => esc_html__( 'Post Author', 'gohigh-seo' ),
				'description' => esc_html__( 'Display author\'s nicename of the current post, page or author archive.', 'gohigh-seo' ),
				'variable'    => 'name',
		...
		$this->register_replacement(
			'user_description',
			[
				'name'        => esc_html__( 'Author Description', 'gohigh-seo' ),
				'description' => esc_html__( 'Author\'s biographical info of the current post, page or author archive.', 'gohigh-seo' ),
