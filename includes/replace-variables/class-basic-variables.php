...
class Basic_Variables extends Cache {
	...
	public function setup_basic_variables() {
		$this->register_replacement(
			...
			[
				...
				'description' => esc_html__( 'Separator character, as set in the Title Settings', 'gohigh-seo' ),
				'variable'    => 'sep',
		...
		$this->register_replacement(
			'search_query',
			[
				'name'        => esc_html__( 'Search Query', 'gohigh-seo' ),
				'description' => esc_html__( 'Search query (only available on search results page)', 'gohigh-seo' ),
				'variable'    => 'search_query',
				'example'     => esc_html__( 'example search', 'gohigh-seo' ),
			],
		...
		$this->register_replacement(
			'count',
			[
				'name'        => esc_html__( 'Counter', 'gohigh-seo' ),
				'description' => esc_html__( 'Starts at 1 and increments by 1.', 'gohigh-seo' ),
		...
		$this->register_replacement(
			'filename',
			[
				'name'        => esc_html__( 'File Name', 'gohigh-seo' ),
				'description' => esc_html__( 'File Name of the attachment', 'gohigh-seo' ),
				'variable'    => 'filename',
	...
	private function setup_site_variables() {
		$this->register_replacement(
			'sitename',
			[
				'name'        => esc_html__( 'Site Title', 'gohigh-seo' ),
				'description' => esc_html__( 'Title of the site', 'gohigh-seo' ),
				'variable'    => 'sitename',
		...
		$this->register_replacement(
			'sitedesc',
			[
				'name'        => esc_html__( 'Site Description', 'gohigh-seo' ),
				'description' => esc_html__( 'Description of the site', 'gohigh-seo' ),
				'variable'    => 'sitedesc',
	...
	private function setup_date_variables() {
		$this->register_replacement(
			'currentdate',
			[
				'name'        => esc_html__( 'Current Date', 'gohigh-seo' ),
				'description' => esc_html__( 'Current server date', 'gohigh-seo' ),
		...
		$this->register_replacement(
			'currentday',
			[
				'name'        => esc_html__( 'Current Day', 'gohigh-seo' ),
				'description' => esc_html__( 'Current server day', 'gohigh-seo' ),
				'variable'    => 'currentday',
		...
		$this->register_replacement(
			'currentmonth',
			[
				'name'        => esc_html__( 'Current Month', 'gohigh-seo' ),
				'description' => esc_html__( 'Current server month', 'gohigh-seo' ),
		...
		$this->register_replacement(
			'currentyear',
			[
				'name'        => esc_html__( 'Current Year', 'gohigh-seo' ),
				'description' => esc_html__( 'Current server year', 'gohigh-seo' ),
	...
	private function setup_time_variables() {
		$this->register_replacement(
			'currenttime',
			[
				'name'        => esc_html__( 'Current Time', 'gohigh-seo' ),
				'description' => esc_html__( 'Current server time', 'gohigh-seo' ),
		...
		$this->register_replacement(
			'currenttime_args',
			[
				'name'        => esc_html__( 'Current Time (advanced)', 'gohigh-seo' ),
				'description' => esc_html__( 'Current server time with custom formatting pattern.', 'gohigh-seo' ),
	...
	private function setup_organization_variables() {
		$this->register_replacement(
			'org_name',
			[
				'name'        => esc_html__( 'Organization Name', 'gohigh-seo' ),
				'description' => esc_html__( 'The Organization Name added in Local SEO Settings.', 'gohigh-seo' ),
				'variable'    => 'org_name',
		...
		$this->register_replacement(
			'org_logo',
			[
				'name'        => esc_html__( 'Organization Logo', 'gohigh-seo' ),
				'description' => esc_html__( 'Organization Logo added in Local SEO Settings.', 'gohigh-seo' ),
				'variable'    => 'org_logo',
		...
		$this->register_replacement(
			'org_url',
			[
				'name'        => esc_html__( 'Organization URL', 'gohigh-seo' ),
				'description' => esc_html__( 'Organization URL added in Local SEO Settings.', 'gohigh-seo' ),
				'variable'    => 'org_url',
