...
class Post_Variables extends Advanced_Variables {
	...
	public function setup_post_variables() {
		...
		$this->register_replacement(
			'title',
			[
				'name'        => esc_html__( 'Post Title', 'gohigh-seo' ),
				'description' => esc_html__( 'Title of the current post/page', 'gohigh-seo' ),
				'variable'    => 'title',
		...
		$this->register_replacement(
			'parent_title',
			[
				'name'        => esc_html__( 'Post Title of parent page', 'gohigh-seo' ),
				'description' => esc_html__( 'Title of the parent page of the current post/page', 'gohigh-seo' ),
		...
		$this->register_replacement(
			'excerpt',
			[
				'name'        => esc_html__( 'Post Excerpt', 'gohigh-seo' ),
				'description' => esc_html__( 'Excerpt of the current post (or auto-generated if it does not exist)', 'gohigh-seo' ),
				'variable'    => 'excerpt',
		...
		$this->register_replacement(
			...
			[
				'name'        => esc_html__( 'Post Excerpt', 'gohigh-seo' ),
				'description' => esc_html__( 'Excerpt of the current post (without auto-generation)', 'gohigh-seo' ),
				'variable'    => 'excerpt_only',
				'example'     => $this->is_post_edit && $this->args->post_excerpt ? $this->args->post_excerpt : esc_html__( 'Post Excerpt Only', 'gohigh-seo' ),
				'nocache'     => true,
			],
		...
		$this->register_replacement(
			'seo_title',
			[
				'name'        => esc_html__( 'SEO Title', 'gohigh-seo' ),
				'description' => esc_html__( 'Custom or Generated SEO Title of the current post/page', 'gohigh-seo' ),
				'variable'    => 'seo_title',
				'example'     => $this->get_title(),
				'nocache'     => true,
			],
		...
		$this->register_replacement(
			'seo_description',
			[
				'name'        => esc_html__( 'SEO Description', 'gohigh-seo' ),
				'description' => esc_html__( 'Custom or Generated SEO Description of the current post/page', 'gohigh-seo' ),
		...
		$this->register_replacement(
			'url',
			[
				'name'        => esc_html__( 'Post URL', 'gohigh-seo' ),
				'description' => esc_html__( 'URL of the current post/page', 'gohigh-seo' ),
				'variable'    => 'url',
		...
		$this->register_replacement(
			'post_thumbnail',
			[
				'name'        => esc_html__( 'Post Thumbnail', 'gohigh-seo' ),
				'description' => esc_html__( 'Current Post Thumbnail', 'gohigh-seo' ),
	...
	public function setup_post_dates_variables() {
		$this->register_replacement(
			'date',
			[
				'name'        => esc_html__( 'Date Published', 'gohigh-seo' ),
				'description' => wp_kses_post( __( 'Publication date of the current post/page <strong>OR</strong> specified date on date archives', 'gohigh-seo' ) ),
				'variable'    => 'date',
		...
		$this->register_replacement(
			'modified',
			[
				'name'        => esc_html__( 'Date Modified', 'gohigh-seo' ),
				'description' => esc_html__( 'Last modification date of the current post/page', 'gohigh-seo' ),
				'variable'    => 'modified',
		...
		$this->register_replacement(
			'date_args',
			[
				'name'        => esc_html__( 'Date Published (advanced)', 'gohigh-seo' ),
				'description' => esc_html__( 'Publish date with custom formatting pattern.', 'gohigh-seo' ),
		...
		$this->register_replacement(
			'modified_args',
			[
				'name'        => esc_html__( 'Date Modified (advanced)', 'gohigh-seo' ),
				'description' => esc_html__( 'Modified date with custom formatting pattern.', 'gohigh-seo' ),
	...
	public function setup_post_category_variables() {
		...
		$this->register_replacement(
			'category',
			[
				'name'        => esc_html__( 'Post Category', 'gohigh-seo' ),
				'description' => wp_kses_post( __( 'First category (alphabetically) associated to the current post <strong>OR</strong> current category on category archives', 'gohigh-seo' ) ),
				'variable'    => 'category',
				'example'     => $category ? $category : esc_html__( 'Example Category', 'gohigh-seo' ),
			],
			[ $this, 'get_category' ]
		);
		...
		$this->register_replacement(
			'categories',
			[
				'name'        => esc_html__( 'Post Categories', 'gohigh-seo' ),
				'description' => esc_html__( 'Comma-separated list of categories associated to the current post', 'gohigh-seo' ),
				'variable'    => 'categories',
				'example'     => $categories ? $categories : esc_html__( 'Example Category 1, Example Category 2', 'gohigh-seo' ),
			],
			[ $this, 'get_categories' ]
		);
		...
		$this->register_replacement(
			'categories_args',
			[
				'name'        => esc_html__( 'Categories (advanced)', 'gohigh-seo' ),
				'description' => esc_html__( 'Output list of categories associated to the current post, with customization options.', 'gohigh-seo' ),
		...
		$this->register_replacement(
			...
			[
				'name'        => esc_html__( 'Primary Terms', 'gohigh-seo' ),
				'variable'    => 'primary_taxonomy_terms',
				'description' => esc_html__( 'Output list of terms from the primary taxonomy associated to the current post.', 'gohigh-seo' ),
	...
	public function setup_post_tags_variables() {
		...
		$this->register_replacement(
			'tag',
			[
				'name'        => esc_html__( 'Post Tag', 'gohigh-seo' ),
				'description' => wp_kses_post( __( 'First tag (alphabetically) associated to the current post <strong>OR</strong> current tag on tag archives', 'gohigh-seo' ) ),
				'variable'    => 'tag',
				'example'     => $tag ? $tag : esc_html__( 'Example Tag', 'gohigh-seo' ),
				'nocache'     => true,
			],
			[ $this, 'get_tag' ]
		);
		...
		$this->register_replacement(
			'tags',
			[
				'name'        => esc_html__( 'Post Tags', 'gohigh-seo' ),
				'description' => esc_html__( 'Comma-separated list of tags associated to the current post', 'gohigh-seo' ),
				'variable'    => 'tags',
				'example'     => $tags ? $tags : esc_html__( 'Example Tag 1, Example Tag 2', 'gohigh-seo' ),
				'nocache'     => true,
			],
			[ $this, 'get_tags' ]
		);
		...
		$this->register_replacement(
			'tags_args',
			[
				'name'        => esc_html__( 'Tags (advanced)', 'gohigh-seo' ),
				'description' => esc_html__( 'Output list of tags associated to the current post, with customization options.', 'gohigh-seo' ),
