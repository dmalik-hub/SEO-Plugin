...
namespace GoHighSEO\BuddyPress;
...
class BuddyPress {
	...
	public function register_replacements() {
		rank_math_register_var_replacement(
			'group_name',
			[
				'name'        => esc_html__( 'Group name.', 'gohigh-seo' ),
				'description' => esc_html__( 'Group name of the current group', 'gohigh-seo' ),
				'variable'    => 'group_name',
		...
		rank_math_register_var_replacement(
			...
			[
				...
				'description' => esc_html__( 'Group description of the current group', 'gohigh-seo' ),
				'variable'    => 'group_desc',
