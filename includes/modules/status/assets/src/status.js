...
class RankMathUpdateSEOScoreTool {
	 ...
	 */
	constructor() {
		addAction( 'rank_math_pre_update_seo_score', 'gohigh-seo', this.applyContentBoundaries )
		addFilter( 'rank_math_update_score_researches_tests', 'gohigh-seo', this.researchesTests )
		addFilter( 'rank_math_status_import_export_tabs', 'gohigh-seo', ( data, props ) => ( <CSVFile { ...props } /> ) )
	}
	...
	applyContentBoundaries( data ) {
		addFilter( 'rankMath_analysis_contentLength_boundaries', 'gohigh-seo', () => {
			return {
				recommended: {
					boundary: 200,
					score: 8,
