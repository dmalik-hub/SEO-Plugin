...
class Image_Seo_Pro {
	...
	public function register_replacements() {
		rank_math_register_var_replacement(
			'imagealt',
			[
				'name'        => esc_html__( 'Image Alt', 'gohigh-seo' ),
				'description' => esc_html__( 'Alt text set for the current image.', 'gohigh-seo' ),
				'variable'    => 'imagealt',
				'example'     => '',
				'nocache'     => true,
			],
		...
		rank_math_register_var_replacement(
			'imagetitle',
			[
				'name'        => esc_html__( 'Image Title', 'gohigh-seo' ),
				'description' => esc_html__( 'Title text set for the current image.', 'gohigh-seo' ),
				'variable'    => 'imagetitle',
				'example'     => '',
				'nocache'     => true,
			],
	...
	public function avatar_add_missing_alt( $avatar, $id_or_email, $size, $default, $alt, $args ) { // phpcs:ignore
		...
		$attrs['alt'] = sprintf( __( 'Avatar of %s', 'gohigh-seo' ), $new_alt );
		$attrs['alt'] = apply_filters( 'rank_math/images/avatar_alt', $attrs['alt'], $id_or_email );
