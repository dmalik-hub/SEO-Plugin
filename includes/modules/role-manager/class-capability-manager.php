...
namespace GoHighSEO\Role_Manager;
...
class Capability_Manager {
	...
	public function set_capabilities() {
		$this->register( 'rank_math_titles', esc_html__( 'Titles & Meta Settings', 'gohigh-seo' ) );
		$this->register( 'rank_math_general', esc_html__( 'General Settings', 'gohigh-seo' ) );
		$this->register( 'rank_math_sitemap', esc_html__( 'Sitemap Settings', 'gohigh-seo' ) );
		$this->register( 'rank_math_404_monitor', esc_html__( '404 Monitor Log', 'gohigh-seo' ) );
		$this->register( 'rank_math_link_builder', esc_html__( 'Link Builder', 'gohigh-seo' ) );
		$this->register( 'rank_math_redirections', esc_html__( 'Redirections', 'gohigh-seo' ) );
		$this->register( 'rank_math_role_manager', esc_html__( 'Role Manager', 'gohigh-seo' ) );
		$this->register( 'rank_math_analytics', esc_html__( 'Analytics', 'gohigh-seo' ) );
		$this->register( 'rank_math_site_analysis', esc_html__( 'Site-Wide Analysis', 'gohigh-seo' ) );
		$this->register( 'rank_math_onpage_analysis', esc_html__( 'On-Page Analysis', 'gohigh-seo' ) );
		$this->register( 'rank_math_onpage_general', esc_html__( 'On-Page General Settings', 'gohigh-seo' ) );
		$this->register( 'rank_math_onpage_advanced', esc_html__( 'On-Page Advanced Settings', 'gohigh-seo' ) );
		$this->register( 'rank_math_onpage_snippet', esc_html__( 'On-Page Schema Settings', 'gohigh-seo' ) );
		$this->register( 'rank_math_onpage_social', esc_html__( 'On-Page Social Settings', 'gohigh-seo' ) );
		$this->register( 'rank_math_content_ai', esc_html__( 'Content AI', 'gohigh-seo' ) );
		$this->register( 'rank_math_admin_bar', esc_html__( 'Top Admin Bar', 'gohigh-seo' ) );
	}
