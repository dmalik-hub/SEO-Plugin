...
export default ( {
	...
	if ( isUndefined( attributes.headings ) || attributes.headings.length === 0 ) {
		return (
			<div { ...blockProps }>
				<Placeholder
					label={ __( 'Table of Contents', 'gohigh-seo' ) }
					instructions={ __( 'Add Heading blocks to this page to generate the Table of Contents.', 'gohigh-seo' ) }
				/>
	...
	return (
		<div { ...blockProps }>
			<RichText
				...
				placeholder={ __( 'Enter a title', 'gohigh-seo' ) }
			/>
			<nav>
				<ListStyle>
					<List
