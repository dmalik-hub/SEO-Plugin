		...
		<div { ...blockProps }>
			...
			>
				...
				<div className={ 'rank-math-howto-duration' }>
					...
					>
						<span>{ __( 'Duration', 'gohigh-seo' ) }</span>
					...
					>
						<TextControl
							...
							placeholder={ __( 'Total time:', 'gohigh-seo' ) }
							onChange={ ( timeLabel ) => {
				...
				>
					{ __( 'Add New Step', 'gohigh-seo' ) }
				</Button>

				<a
					href="http://rankmath.com/blog/howto-schema/"
					title={ __( 'More Info', 'gohigh-seo' ) }
					target="_blank"
