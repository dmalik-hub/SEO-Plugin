...
namespace GoHighSEO\Schema\Blocks;
		...
		Arr::insert(
			...
			[
				'blocks' => [
					...
					'title' => esc_html__( 'Blocks', 'gohigh-seo' ),
					'desc'  => esc_html__( 'Take control over the default settings available for Rank Math Blocks.', 'gohigh-seo' ),
