...
use GoHighSEO\Schema\Snippet_Shortcode;
...
class Snippet_Pro_Shortcode extends Snippet_Shortcode {
	...
	public function add_shortcode_view( $html, $schema, $post, $shortcode ) { // phpcs:ignore
		wp_enqueue_style( 'rank-math-review-pro-snippet', RANK_MATH_PRO_URL . 'includes/modules/schema/assets/css/rank-math-snippet.css', null, rank_math()->version );
	...
	public function show_review_notes( $shortcode ) {
		$labels = [
			'pros' => __( 'Pros', 'gohigh-seo' ),
			'cons' => __( 'Cons', 'gohigh-seo' ),
		];
