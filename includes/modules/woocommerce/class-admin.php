...
class Admin {
	...
	public function add_gtin_field() {
		...
		$label = 'isbn' === $gtin ? esc_html__( 'ISBN', 'gohigh-seo' ) : ( 'mpn' === $gtin ? esc_html__( 'MPN', 'gohigh-seo' ) : esc_html__( 'GTIN', 'gohigh-seo' ) );
		?>
		<div class="options_group">
			...
			woocommerce_wp_text_input(
				[
					...
					'description' => sprintf( esc_html__( '%s added by Rank Math SEO). This field overrides WooCommerce GTIN data used in the Product Schema.', 'gohigh-seo' ), $label ),
				]
			);
			?>
		</div>
