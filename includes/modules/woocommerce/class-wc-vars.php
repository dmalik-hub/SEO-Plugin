...
namespace GoHighSEO\WooCommerce;
...
class WC_Vars extends Opengraph {
	...
	public function register() {
		rank_math_register_var_replacement(
			'wc_price',
			[
				'name'        => esc_html__( 'Product\'s price.', 'gohigh-seo' ),
				'description' => esc_html__( 'Product\'s price of the current product', 'gohigh-seo' ),
				'variable'    => 'wc_price',
		...
		rank_math_register_var_replacement(
			'wc_sku',
			[
				'name'        => esc_html__( 'Product\'s SKU.', 'gohigh-seo' ),
				'description' => esc_html__( 'Product\'s SKU of the current product', 'gohigh-seo' ),
				'variable'    => 'wc_sku',
		...
		rank_math_register_var_replacement(
			'wc_shortdesc',
			[
				'name'        => esc_html__( 'Product\'s short description.', 'gohigh-seo' ),
				'description' => esc_html__( 'Product\'s short description of the current product', 'gohigh-seo' ),
		...
		rank_math_register_var_replacement(
			'wc_brand',
			[
				'name'        => esc_html__( 'Product\'s brand.', 'gohigh-seo' ),
				'description' => esc_html__( 'Product\'s brand of the current product', 'gohigh-seo' ),
				'variable'    => 'wc_brand',
