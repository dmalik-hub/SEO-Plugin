...
class Migrate_GTIN extends \WP_Background_Process {
	...
	protected function complete() {
		...
		Helper::add_notification(
			...
			sprintf( _n( 'GTIN value has been successfully migrated to the WooCommerce GTIN field for %d product.', 'GTIN values have been successfully migrated to the WooCommerce GTIN field for %d products.', $count, 'gohigh-seo' ), $count ),
			[
				'type'    => 'success',
