		...
		Arr::insert(
			...
			[
				'llms' => [
					...
					'title'   => esc_html__( 'Edit llms.txt', 'gohigh-seo' ),
					'desc'    => esc_html__( 'Configure your llms.txt file for custom crawling/indexing rules.', 'gohigh-seo' ),
