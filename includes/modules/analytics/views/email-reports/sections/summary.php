...
<table role="presentation" border="0" cellpadding="0" cellspacing="0" class="stats">
	<tr>
		<?php if ( $is_analytics_connected ) : ?>
			<td class="col-1">
				<h3><?php esc_html_e( 'Search Traffic', 'gohigh-seo' ); ?></h3>
				<?php
				$this->template_part(
					'stat',
					[
		...
		<?php else : ?>
			<td class="col-1">
				<h3><?php esc_html_e( 'Total Impressions', 'gohigh-seo' ); ?></h3>
				<?php
				$this->template_part(
					'stat',
					[
		...
		<?php if ( ! $is_analytics_connected ) : ?>
			<td class="col-2">
				<h3><?php esc_html_e( 'Total Clicks', 'gohigh-seo' ); ?></h3>
				<?php
				$this->template_part(
					'stat',
					[
	...
	<tr>
		<td class="col-1">
			<h3><?php esc_html_e( 'Total Keywords', 'gohigh-seo' ); ?></h3>
			<?php
			$this->template_part(
				'stat',
				[
		...
		<td class="col-2">
			<h3><?php esc_html_e( 'Average Position', 'gohigh-seo' ); ?></h3>
			<?php
			$this->template_part(
				'stat',
				[
