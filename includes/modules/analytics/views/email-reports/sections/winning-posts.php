...
use GoHighSEO\Analytics\Email_Reports;
...
<table role="presentation" border="0" cellpadding="0" cellspacing="0" class="report-heading">
	<tr>
		<td>
			<h2><?php esc_html_e( 'Top Winning Posts', 'gohigh-seo' ); ?></h2>
		</td>
	</tr>
</table>
...
<table role="presentation" border="0" cellpadding="0" cellspacing="0" class="traffic-table stats-table">
	<tr class="table-heading">
		<td class="col-1">
			<?php esc_html_e( 'Post', 'gohigh-seo' ); ?>
		</td>
		<?php if ( ! empty( $analytics_connected ) ) : ?>
			<td class="col-2">
				<?php esc_html_e( 'Search Traffic', 'gohigh-seo' ); ?>
			</td>
		<?php else : ?>
			<td class="col-2">
				<?php esc_html_e( 'Impressions', 'gohigh-seo' ); ?>
			</td>
		<?php endif; ?>
		<td class="col-3">
			<?php esc_html_e( 'Position', 'gohigh-seo' ); ?>
		</td>
	</tr>
	...
	<?php if ( empty( $posts ) ) : ?>
		<tr>
			<td colspan="3">
				<?php esc_html_e( 'No data to show.', 'gohigh-seo' ); ?>
			</td>
		</tr>
	<?php endif; ?>
</table>
