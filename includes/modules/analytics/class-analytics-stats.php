...
class Analytics_Stats {
	...
	public function enqueue() {
		...
		Helper::add_json( 'isConsoleConnected', \GoHighSEO\Google\Console::is_console_connected() );
		Helper::add_json( 'isAnalyticsConnected', \GoHighSEO\Google\Analytics::is_analytics_connected() );
