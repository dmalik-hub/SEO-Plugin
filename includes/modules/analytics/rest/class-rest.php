 ...
 * Rest class.
 */
class Free_Analytics_Rest extends WP_REST_Controller {
	...
	public function register_routes() {
		$routes = [
			...
			'analyticsSummary'    => [
				...
				'args'     => [
					'postType' => [
						'description' => esc_html__( 'Post Type.', 'gohigh-seo' ),
						'type'        => 'string',
					],
				],
			],
			'keywordsRows'        => [
				...
				'args'     => [
					...
					'perPage' => [
						'description' => esc_html__( 'Results per page.', 'gohigh-seo' ),
						'type'        => 'integer',
						'required'    => false,
					],
					'orderBy' => [
						'description' => esc_html__( 'Order by.', 'gohigh-seo' ),
						'type'        => 'string',
						'required'    => false,
					],
					'order'   => [
						'description' => esc_html__( 'Order.', 'gohigh-seo' ),
						'type'        => 'string',
						'required'    => false,
					],
					'search'  => [
						'description' => esc_html__( 'Search.', 'gohigh-seo' ),
						'type'        => 'string',
						'required'    => false,
					],
				],
			...
			'userPreferences'     => [
				...
				'args'     => [
					'preferences' => [
						'description' => esc_html__( 'User preferences.', 'gohigh-seo' ),
						'type'        => 'object',
						'required'    => true,
					],
				],
			...
			'inspectionResults'   => [
				...
				'args'     => [
					...
					'filter'     => [
						'description' => esc_html__( 'Filter.', 'gohigh-seo' ),
						'type'        => 'string',
						'required'    => false,
					],
					'filterType' => [
						'description' => esc_html__( 'Filter type.', 'gohigh-seo' ),
						'type'        => 'string',
						'required'    => false,
					],
				],
			...
			'removeFrontendStats' => [
				...
				'args'     => [
					'toggleBar' => [
						'description' => esc_html__( 'Toggle bar.', 'gohigh-seo' ),
						'type'        => 'boolean',
						'required'    => false,
					],
					'hide'      => [
						'description' => esc_html__( 'Hide.', 'gohigh-seo' ),
						'type'        => 'boolean',
						'required'    => false,
					],
				],
	...
	public function update_user_preferences( WP_REST_Request $request ) {
		...
		if ( empty( $pref ) ) {
			return new WP_Error(
				'param_value_empty',
				esc_html__( 'Sorry, no preference found.', 'gohigh-seo' )
			);
		}
	...
	public function get_post( WP_REST_Request $request ) {
		...
		if ( empty( $id ) ) {
			return new WP_Error(
				'param_value_empty',
				esc_html__( 'Sorry, no post id found.', 'gohigh-seo' )
			);
		}
