...
namespace GoHighSEO\Links;

use WP_Post;
use GoHighSEO\Helper;
use GoHighSEO\Traits\Hooker;
use GoHighSEO\Admin\Database\Database;
use GoHighSEO\Admin\Post_Columns;
use GoHighSEO\Links\Admin\Admin;
use GoHighSEO\Links\Api\Controller;
...
class Links {
	...
	private function get_default_link_count_html( $post_id, $counts ) {
		...
		<span class="rank-math-column-display rank-math-link-count">
			<strong><?php esc_html_e( 'Links: ', 'gohigh-seo' ); ?></strong>
			<?php
			/**
	...
	private function get_link_count_item_html( $type, $count, $post_id ) {
		...
		$titles = [
			'internal' => __( 'Internal Links', 'gohigh-seo' ),
			'external' => __( 'External Links', 'gohigh-seo' ),
			'incoming' => __( 'Incoming Links', 'gohigh-seo' ),
		];
