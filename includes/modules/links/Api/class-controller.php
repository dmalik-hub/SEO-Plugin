...
class Controller {
	...
	public function check_permission() {
		if ( ! current_user_can( 'manage_options' ) ) {
			return new \WP_Error(
				'rest_forbidden',
				esc_html__( 'You do not have permission to access this resource.', 'gohigh-seo' ),
	...
	private function get_posts_args() {
		return [
			...
			'search'          => [
				'description'       => esc_html__( 'Search in post title.', 'gohigh-seo' ),
				'type'              => 'string',
				'default'           => '',
				'sanitize_callback' => 'sanitize_text_field',
			],
			'post_type'       => [
				'description'       => esc_html__( 'Filter by post type. Supports multiple values.', 'gohigh-seo' ),
				'type'              => 'array',
				'items'             => [ 'type' => 'string' ],
				'default'           => [],
			...
			'is_orphan'       => [
				'description'       => esc_html__( 'Filter by orphan status (orphan, linked).', 'gohigh-seo' ),
				'type'              => 'string',
				'default'           => '',
				'sanitize_callback' => 'sanitize_text_field',
			],
			'seo_score_range' => [
				'description'       => esc_html__( 'Filter by SEO score range (great, good, bad, no-score).', 'gohigh-seo' ),
				'type'              => 'string',
				'default'           => '',
				'sanitize_callback' => 'sanitize_text_field',
			],
			'post_id'         => [
				'description'       => esc_html__( 'Filter by post ID.', 'gohigh-seo' ),
				'type'              => 'integer',
				'default'           => 0,
			...
			'order'           => [
				'description'       => esc_html__( 'Order direction (ASC, DESC).', 'gohigh-seo' ),
				'type'              => 'string',
				'default'           => 'ASC',
				'sanitize_callback' => 'sanitize_text_field',
			],
	...
	private function get_links_args() {
		return [
			...
			'search'         => [
				'description'       => esc_html__( 'Search in URL.', 'gohigh-seo' ),
				'type'              => 'string',
				'default'           => '',
				'sanitize_callback' => 'sanitize_text_field',
			],
			...
			'is_internal'    => [
				'description'       => esc_html__( 'Filter by link type (1 = internal, 0 = external).', 'gohigh-seo' ),
				'type'              => 'string',
				'default'           => '',
				'sanitize_callback' => 'sanitize_text_field',
			],
