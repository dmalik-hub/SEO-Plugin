...
const getTabs = () => [
	...
	},
	{
		id: 'bulk-update',
		name: 'bulk-update',
		title: __( 'Bulk Update', 'gohigh-seo' ),
		view: BulkUpdate,
	...
	},
	{
		id: 'keyword-maps',
		name: 'keyword-maps',
		title: __( 'Keyword Maps', 'gohigh-seo' ),
		view: KeywordMaps,
...
const LinksPage = () => {
	...
	return (
		<>
			<DashboardHeader page={ __( 'Link Genius', 'gohigh-seo' ) } />
