...
class Monitor {
	...
	public function dashboard_widget() {
		...
		<h3>
			...
			<a href="<?php echo esc_url( Helper::get_admin_url( '404-monitor' ) ); ?>" class="rank-math-view-report" title="<?php esc_html_e( 'View Report', 'gohigh-seo' ); ?>"><i class="dashicons dashicons-chart-bar"></i></a>
		</h3>
		<div class="rank-math-dashboard-block">
			<div>
				<h4>
					<?php esc_html_e( 'Log Count', 'gohigh-seo' ); ?>
					<span class="rank-math-tooltip"><em class="dashicons-before dashicons-editor-help"></em><span><?php esc_html_e( 'Total number of 404 pages opened by the users.', 'gohigh-seo' ); ?></span></span>
				</h4>
				<strong class="text-large"><?php echo esc_html( Str::human_number( $data->total ) ); ?></strong>
			</div>
			<div>
				<h4>
					<?php esc_html_e( 'URL Hits', 'gohigh-seo' ); ?>
					<span class="rank-math-tooltip"><em class="dashicons-before dashicons-editor-help"></em><span><?php esc_html_e( 'Total number visits received on all the 404 pages.', 'gohigh-seo' ); ?></span></span>
				</h4>
	...
	public function admin_bar_items( $menu ) {
		$menu->add_sub_menu(
			...
			[
				...
				'meta'     => [ 'title' => esc_html__( 'Review 404 errors on your site', 'gohigh-seo' ) ],
				'priority' => 50,
			]
		);
	}
	...
	public function delete_log() {
		...
		DB::delete_log( $id );
		$this->success( esc_html__( 'Log item successfully deleted.', 'gohigh-seo' ) );
	}
