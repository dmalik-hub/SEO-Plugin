...
use GoHighSEO\Link_Genius\Services\Related_Posts;
use GoHighSEO\Link_Genius\Services\Utils;
use GoHighSEO\Link_Genius\Services\Content_Similarity;
		...
		register_rest_route(
			...
			[
				...
				'args'                => [
					...
					'text'    => [
						'description' => esc_html__( 'Selected text used for suggestions.', 'gohigh-seo' ),
						'type'        => 'string',
						'required'    => false,
					],
					'current' => [
						'description' => esc_html__( 'Current editor state summary.', 'gohigh-seo' ),
						'type'        => 'object',
						'required'    => false,
					],
				],
