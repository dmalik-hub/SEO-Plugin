...
class Posts_Controller extends Base_Controller {
	...
	public function regenerate_links( $request ) {
		...
		if ( ! $started ) {
			return $this->error(
				'no_posts_found',
				__( 'No posts found to process.', 'gohigh-seo' ),
				400
			);
		}
	...
	private function get_posts_args() {
		return [
			...
			'is_orphan'          => [
				'description' => esc_html__( 'Filter by orphan status.', 'gohigh-seo' ),
				'type'        => 'string',
				'default'     => '',
			],
			'seo_score_range'    => [
				'description' => esc_html__( 'Filter by SEO score range.', 'gohigh-seo' ),
				'type'        => 'string',
				'default'     => '',
			],
			'orderby'            => [
			...
			'min_incoming_links' => [
				'description' => esc_html__( 'Minimum incoming links count filter.', 'gohigh-seo' ),
				'type'        => 'integer',
				'default'     => 0,
			],
		];
