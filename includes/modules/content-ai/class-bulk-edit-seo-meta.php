...
class Bulk_Edit_SEO_Meta extends \WP_Background_Process {
	...
	public function start( $data ) {
		Helper::add_notification(
			esc_html__( 'Bulk editing SEO meta started. It might take few minutes to complete the process.', 'gohigh-seo' ),
			[
				'type'    => 'success',
	...
	protected function complete() {
		...
		Helper::add_notification(
			...
			sprintf( _n( 'SEO meta successfully updated in %d item.', 'SEO meta successfully updated in %d items.', count( $posts ), 'gohigh-seo' ), count( $posts ) ),
			[
				'type'    => 'success',
		...
		try {
			...
			if ( Helper::is_feature_quota_exhausted( 'bulk_seo_meta' ) ) {
				...
				Helper::add_notification(
					...
					sprintf( esc_html__( 'SEO meta successfully updated in %d posts. The process was stopped as you have reached the monthly limit for this feature.', 'gohigh-seo' ), (int) $posts_processed ),
					[
						'type'    => 'success',
						'id'      => 'rank_math_content_ai_posts',
						'classes' => 'rank-math-notice',
