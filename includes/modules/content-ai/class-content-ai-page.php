...
class Content_AI_Page {
	...
	public function register_admin_page() {
		...
		new Page(
			...
			esc_html__( 'Content AI', 'gohigh-seo' ),
			[
				'position'   => 4,
				'parent'     => 'rank-math',
				'menu_title' => esc_html__( 'Content AI', 'gohigh-seo' ),
	...
	public function admin_bar_items( $menu ) {
		...
		$items = [
			'content-ai-tools'   => [
				'title' => esc_html__( 'AI Tools', 'gohigh-seo' ),
				'href'  => $url . '#ai-tools',
				'meta'  => [ 'title' => esc_html__( 'Content AI Tools', 'gohigh-seo' ) ],
			],

			'content-ai-editor'  => [
				'title' => esc_html__( 'Content Editor', 'gohigh-seo' ),
				'href'  => $url . '#content-editor',
				'meta'  => [ 'title' => esc_html__( 'Content AI Editor', 'gohigh-seo' ) ],
			],

			'content-ai-chat'    => [
				'title' => esc_html__( 'Chat', 'gohigh-seo' ),
				'href'  => $url . '#chat',
				'meta'  => [ 'title' => esc_html__( 'Content AI Chat', 'gohigh-seo' ) ],
			],

			'content-ai-history' => [
				'title' => esc_html__( 'History', 'gohigh-seo' ),
				'href'  => $url . '#history',
				'meta'  => [ 'title' => esc_html__( 'Content AI History', 'gohigh-seo' ) ],
			],
		];
	...
	public function content_editor_settings() {
		...
		wp_set_script_translations( 'rank-math-content-ai', 'gohigh-seo' );
		wp_set_script_translations( 'rank-math-content-ai-page', 'gohigh-seo' );
	}
