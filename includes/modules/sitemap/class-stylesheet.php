...
class Stylesheet extends XML {
	...
	public function output( $type ) {
		...
		$title = sprintf( __( 'XML Sitemap %1$s %2$s', 'gohigh-seo' ), '-', get_bloginfo( 'name', 'display' ) );

		/* translators: 1. separator, 2. blogname */
		$kml_title = sprintf( __( 'Locations Sitemap %1$s %2$s', 'gohigh-seo' ), '-', get_bloginfo( 'name', 'display' ) );
