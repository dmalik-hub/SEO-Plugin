...
use GoHighSEO\Sitemap\Cache_Watcher;
...
class Local_Seo {
	...
	private function register_location_post_type() {
		...
		$labels         = [
			...
			'all_items'                => sprintf( esc_html__( 'All %s', 'gohigh-seo' ), $plural_label ),
			/* translators: Post Type Singular Name */
			'add_new_item'             => sprintf( esc_html__( 'Add New %s', 'gohigh-seo' ), $this->post_singular_name ),
			/* translators: Post Type Singular Name */
			'new_item'                 => sprintf( esc_html__( 'New %s', 'gohigh-seo' ), $this->post_singular_name ),
			/* translators: Post Type Singular Name */
			'edit_item'                => sprintf( esc_html__( 'Edit %s', 'gohigh-seo' ), $this->post_singular_name ),
			/* translators: Post Type Singular Name */
			'update_item'              => sprintf( esc_html__( 'Update %s', 'gohigh-seo' ), $this->post_singular_name ),
			/* translators: Post Type Singular Name */
			'view_item'                => sprintf( esc_html__( 'View %s', 'gohigh-seo' ), $this->post_singular_name ),
			/* translators: Post Type Plural Name */
			'view_items'               => sprintf( esc_html__( 'View %s', 'gohigh-seo' ), $plural_label ),
			/* translators: Post Type Singular Name */
			'search_items'             => sprintf( esc_html__( 'Search %s', 'gohigh-seo' ), $this->post_singular_name ),
			/* translators: Post Type Singular Name */
			'not_found'                => sprintf( esc_html__( 'No %s found.', 'gohigh-seo' ), $plural_label ),
			/* translators: Post Type Singular Name */
			'not_found_in_trash'       => sprintf( esc_html__( 'No %s found in Trash.', 'gohigh-seo' ), $plural_label ),
			/* translators: Post Type Singular Name */
			'item_published'           => sprintf( esc_html__( '%s published.', 'gohigh-seo' ), $this->post_singular_name ),
			/* translators: Post Type Singular Name */
			'item_published_privately' => sprintf( esc_html__( '%s published privately.', 'gohigh-seo' ), $this->post_singular_name ),
			/* translators: Post Type Singular Name */
			'item_reverted_to_draft'   => sprintf( esc_html__( '%s reverted to draft.', 'gohigh-seo' ), $this->post_singular_name ),
			/* translators: Post Type Singular Name */
			'item_scheduled'           => sprintf( esc_html__( '%s scheduled.', 'gohigh-seo' ), $this->post_singular_name ),
			/* translators: Post Type Singular Name */
			'item_updated'             => sprintf( esc_html__( '%s updated.', 'gohigh-seo' ), $this->post_singular_name ),
		];
	...
	private function register_location_taxonomy() {
		...
		$labels        = [
			/* translators: Post Type Singular Name */
			'name'              => sprintf( esc_html__( '%s categories', 'gohigh-seo' ), $this->post_singular_name ),
			/* translators: Post Type Singular Name */
			'singular_name'     => sprintf( esc_html__( '%s category', 'gohigh-seo' ), $this->post_singular_name ),
			/* translators: Post Type Singular Name */
			'all_items'         => sprintf( esc_html__( 'All %s categories', 'gohigh-seo' ), $this->post_singular_name ),
			/* translators: Post Type Singular Name */
			'edit_item'         => sprintf( esc_html__( 'Edit %s category', 'gohigh-seo' ), $this->post_singular_name ),
			/* translators: Post Type Singular Name */
			'update_item'       => sprintf( esc_html__( 'Update %s category', 'gohigh-seo' ), $this->post_singular_name ),
			/* translators: Post Type Singular Name */
			'add_new_item'      => sprintf( esc_html__( 'Add New %s category', 'gohigh-seo' ), $this->post_singular_name ),
			/* translators: Post Type Singular Name */
			'new_item_name'     => sprintf( esc_html__( 'New %s category', 'gohigh-seo' ), $this->post_singular_name ),
			/* translators: Post Type Singular Name */
			'menu_name'         => sprintf( esc_html__( '%s categories', 'gohigh-seo' ), $this->post_singular_name ),
			'search_items'      => esc_html__( 'Search categories', 'gohigh-seo' ),
			'parent_item'       => esc_html__( 'Parent Category', 'gohigh-seo' ),
			'parent_item_colon' => esc_html__( 'Parent Category:', 'gohigh-seo' ),
		];
	...
	public function posts_columns( $columns ) {
		$columns['address']   = __( 'Address', 'gohigh-seo' );
		$columns['telephone'] = __( 'Phone', 'gohigh-seo' );
	...
	public function posts_custom_column( $column, $post_id ) {
		$schemas = \GoHighSEO\Schema\DB::get_schemas( $post_id );
		if ( empty( $schemas ) ) {
			return;
		}
