...
class Version_Control {
	 ...
	 * @var string
	 */
	const API_URL = 'https://api.wordpress.org/plugins/info/1.0/gohigh-seo.json';
	...
	public static function get_plugin_data( $version, $package ) {
		return [
			'id'          => 'w.org/plugins/gohigh-seo',
			'slug'        => 'gohigh-seo',
			'plugin'      => 'gohigh-seo/rank-math.php',
			'new_version' => $version,
			'url'         => 'https://wordpress.org/plugins/gohigh-seo/',
			'package'     => $package,
			'icons'       =>
			[
				'2x'  => 'https://ps.w.org/gohigh-seo/assets/icon-256x256.png?rev=2034417',
				'1x'  => 'https://ps.w.org/gohigh-seo/assets/icon.svg?rev=2034417',
				'svg' => 'https://ps.w.org/gohigh-seo/assets/icon.svg?rev=2034417',
			],
			'banners'     =>
			[
				'2x' => 'https://ps.w.org/gohigh-seo/assets/banner-1544x500.png?rev=2034417',
				'1x' => 'https://ps.w.org/gohigh-seo/assets/banner-772x250.png?rev=2034417',
			],
			'banners_rtl' => [],
		];
	}
