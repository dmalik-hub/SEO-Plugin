...
use GoHighSEO\Admin\Admin_Helper as Pro_Admin_Helper;
...
class Admin {
	...
	public function add_settings( $tabs ) {
		...
		$tabs['news-sitemap'] = [
			...
			'desc'      => wp_kses_post(
				...
				sprintf( __( 'News Sitemaps allow you to control which content you submit to Google News. More information: <a href="%s" target="_blank">News Sitemaps overview</a>', 'gohigh-seo' ), KB::get( 'news-sitemap', 'Options Panel Sitemap News Tab' ) )
			),
			/* translators: News Sitemap Url */
			'after_row' => '<div class="notice notice-alt notice-info info inline rank-math-notice"><p>' . sprintf( esc_html__( 'Your News Sitemap index can be found here: : %s', 'gohigh-seo' ), '<a href="' . $sitemap_url . '" target="_blank">' . $sitemap_url . '</a>' ) . '</p></div>',
			'json'      => [
	...
	public function enqueue_settings_scripts() {
		...
		wp_enqueue_script(
			'gohigh-seo-news-sitemap-settings',
