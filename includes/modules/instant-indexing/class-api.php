...
class Api {
	...
	private function set_error_message( $message ) {
		...
		$message     = __( 'Unknown error.', 'gohigh-seo' );
		$message_map = [
			400 => __( 'Invalid request.', 'gohigh-seo' ),
			403 => __( 'Invalid API key.', 'gohigh-seo' ),
			422 => __( 'Invalid URL.', 'gohigh-seo' ),
			429 => __( 'Too many requests.', 'gohigh-seo' ),
			500 => __( 'Internal server error.', 'gohigh-seo' ),
		];
