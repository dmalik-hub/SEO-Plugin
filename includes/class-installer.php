...
class Installer {
	...
	private function activate() {
		\GoHighSEO\Admin\Licence_Activation::activate_licence();
		\GoHighSEO\Admin\Api::get()->get_settings();
		$this->create_options();

		// Set up Link Genius tables on fresh install.
		\GoHighSEO\Link_Genius\Data\Table_Extension::initialize_schema();
	...
	private function create_options() {
		...
		$this->enable_default_modules();
	}

	/**
	 * Enable PRO modules that should be active by default on fresh installs.
	 */
	private function enable_default_modules() {
