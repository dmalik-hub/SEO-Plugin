	...
	public static function create_tables( $modules = [] ) {
		...
		if ( $old_schema ) {
			_deprecated_hook(
				...
				'1.0.253',
				'rank_math/admin/create_tables',
				esc_html__( 'The format of the tables array has changed. Please update your code accordingly.', 'gohigh-seo' )
			);
		...
		add_option(
			...
			$this->do_filter(
				...
				[
					...
					'breadcrumbs_home'                    => 'on',
					'breadcrumbs_home_label'              => esc_html__( 'Home', 'gohigh-seo' ),
					/* translators: Archive title */
					'breadcrumbs_archive_format'          => esc_html__( 'Archives for %s', 'gohigh-seo' ),
					/* translators: Search query term */
					'breadcrumbs_search_format'           => esc_html__( 'Results for %s', 'gohigh-seo' ),
					'breadcrumbs_404_label'               => esc_html__( '404 Error: page not found', 'gohigh-seo' ),
