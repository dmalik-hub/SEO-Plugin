...
namespace GoHighSEO\Abilities\Post_SEO;

use GoHighSEO\Abilities\Ability_Interface;
use GoHighSEO\Paper\Singular;
	...
	public function register(): void {
		\wp_register_ability(
			...
			[
				...
				'label'               => esc_html__( 'Get post SEO metadata', 'gohigh-seo' ),
				'description'         => esc_html__( 'Returns the full SEO metadata for a post: title, description, focus keyword, robots settings, canonical URL, Open Graph and Twitter overrides, and the current SEO score.', 'gohigh-seo' ),
				'input_schema'        => [
					'type'                 => 'object',
					'default'              => [],
					'required'             => [ 'post_id' ],
					'properties'           => [
						'post_id' => [
							'type'        => 'integer',
							'description' => esc_html__( 'The ID of the post to retrieve SEO metadata for.', 'gohigh-seo' ),
						],
					],
