...
namespace GoHighSEO\Abilities\Link_Genius;
...
class Link_Report_Runner {
	...
	public function run( array $input = [] ): array {
		...
		if ( ! isset( $result['audit'] ) ) {
			$result['upgrade'] = [
				'message' => \esc_html__( 'Upgrade to Rank Math PRO to unlock broken link detection, redirect chain analysis, and HTTP status distribution from the Link Genius audit.', 'gohigh-seo' ),
