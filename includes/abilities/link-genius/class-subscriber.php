...
use GoHighSEO\Abilities\Subscriber_Interface;
...
class Subscriber implements Subscriber_Interface {
	...
	public function register_category(): void {
		\wp_register_ability_category(
			self::CATEGORY_SLUG,
			[
				'label'       => esc_html__( 'Link Genius', 'gohigh-seo' ),
				'description' => esc_html__( 'Abilities to retrieve and analyse internal and external link data for posts.', 'gohigh-seo' ),
			]
		);
	}
