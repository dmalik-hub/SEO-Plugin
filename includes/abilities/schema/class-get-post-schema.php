...
namespace GoHighSEO\Abilities\Schema;
...
class Get_Post_Schema implements Ability_Interface {
	...
	public function register(): void {
		\wp_register_ability(
			...
			[
				...
				'label'               => esc_html__( 'Get post schema', 'gohigh-seo' ),
				...
				'input_schema'        => [
					...
					'properties'           => [
						'post_id'                 => [
							'type'        => 'integer',
							'description' => esc_html__( 'The ID of the post to retrieve schema markup for.', 'gohigh-seo' ),
						],
						'include_available_types' => [
							'type'        => 'boolean',
							'description' => esc_html__( 'When true (default), includes the schema types available on this install. Always pass true when evaluating which schema to add.', 'gohigh-seo' ),
							'default'     => true,
						],
					],
	...
	public function execute( array $input = [] ): array {
		...
		if ( 0 === $post_id ) {
			return [ 'error' => esc_html__( 'Invalid post ID.', 'gohigh-seo' ) ];
		}
