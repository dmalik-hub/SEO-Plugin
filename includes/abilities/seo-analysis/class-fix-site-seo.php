	...
	public function register(): void {
		\wp_register_ability(
			...
			[
				...
				'label'               => esc_html__( 'Fix site SEO', 'gohigh-seo' ),
				...
				'input_schema'        => [
					...
					'properties'           => [
						'test_id'    => [
							...
							'description' => esc_html__( 'The SEO test identifier to fix (from audit-site-seo findings).', 'gohigh-seo' ),
						],
						'value'      => [
							'type'        => 'string',
							'description' => esc_html__( 'Required for site_description: the new tagline to set.', 'gohigh-seo' ),
						],
						'post_limit' => [
							'type'        => 'integer',
							'minimum'     => 1,
							'maximum'     => 500,
							'description' => esc_html__( 'For bulk post fixes (focus_keywords, post_titles): max posts to update in one call. Default 100.', 'gohigh-seo' ),
						],
					],
