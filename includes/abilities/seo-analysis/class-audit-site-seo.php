	...
	public function register(): void {
		\wp_register_ability(
			...
			[
				...
				'label'               => esc_html__( 'Audit site SEO', 'gohigh-seo' ),
				...
				'input_schema'        => [
					...
					'properties'           => [
						'refresh' => [
							'type'        => 'boolean',
							'description' => esc_html__( 'Re-run the audit. Defaults to true (always fresh when called by an AI host).', 'gohigh-seo' ),
							'default'     => true,
						],
						'url'     => [
							'type'        => 'string',
							'format'      => 'uri',
							'description' => esc_html__( "Optional URL to audit. Defaults to this site's home URL. When provided, only remote API tests run (local checks are site-wide).", 'gohigh-seo' ),
						],
					],
