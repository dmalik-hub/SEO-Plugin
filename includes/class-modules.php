...
class Modules {
	...
	public function setup_core( $modules ) {
		...
		$modules['news-sitemap'] = [
			...
			'dep_modules'   => [ 'sitemap' ],
			'disabled_text' => esc_html__( 'Please activate Sitemap module to use this module.', 'gohigh-seo' ),
		];
		...
		$modules['video-sitemap'] = [
			...
			'disabled_text' => esc_html__( 'Please activate Schema & Sitemap module to use this module.', 'gohigh-seo' ),
		];
		...
		$modules['podcast'] = [
			...
			'disabled_text' => esc_html__( 'Please activate Schema module to use this module.', 'gohigh-seo' ),
		];

		$registered             = \GoHighSEO\Admin\Admin_Helper::get_registration_data();
		$is_connected           = $registered && ! empty( $registered['username'] ) && ! empty( $registered['api_key'] );
		$modules['marketplace'] = [
			'title'         => esc_html__( 'Marketplace', 'gohigh-seo' ),
			'desc'          => esc_html__( 'Discover handpicked WordPress plugins designed to boost your SEO, improve Core Web Vitals, and accelerate your website\'s growth.', 'gohigh-seo' ),
			'class'         => 'RankMathPro\Marketplace\Marketplace',
			'icon'          => 'cart',
			'probadge'      => defined( 'RANK_MATH_PRO_FILE' ),
			'disabled'      => ! $is_connected,
			'disabled_text' => esc_html__( 'Please connect your site to Rank Math to use this module.', 'gohigh-seo' ),
		];

		// Replace Schema Loader.
		$modules['rich-snippet']['class'] = '\GoHighSEO\Schema\Schema';
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'gohigh-seo-dashboard', RANK_MATH_PRO_URL . 'assets/admin/js/dashboard.js', [ 'jquery' ], rank_math()->version, true );
	}
