...
use GoHighSEO\Helpers\Editor;
use GoHighSEO\Frontend_SEO_Score;
...
class Post_Screen implements IScreen {
	...
	public function get_values() {
		...
		return [
			...
			'featuredImageNotice'    => esc_html__( 'The featured image should be at least 200 by 200 pixels to be picked up by Facebook and other social media sites.', 'gohigh-seo' ),
