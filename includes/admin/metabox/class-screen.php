...
class Screen implements IScreen {
	...
	public function get_values() {
		...
		$values = array_merge_recursive(
			...
			[
				...
				'trendsUpgradeLabel'  => esc_html__( 'Upgrade', 'gohigh-seo' ),
	...
	public function get_object_values() {
		...
		$data['twitterAuthor']      = $twitter_username ? $twitter_username : esc_html__( 'username', 'gohigh-seo' );
