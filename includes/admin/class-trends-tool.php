...
class Trends_Tool {
	...
	public function editor_scripts() {
		...
		wp_set_script_translations( 'gohigh-seo-editor', 'gohigh-seo', RANK_MATH_PRO_PATH . 'languages/' );
		wp_enqueue_style( 'gohigh-seo-editor', RANK_MATH_PRO_URL . 'assets/admin/css/gutenberg.css', [], RANK_MATH_PRO_VERSION );
	}
}
