...
class Your_Site implements Wizard_Step {
	...
	private function get_type_choices() {
		return [
			'blog'          => esc_html__( 'Personal Blog', 'gohigh-seo' ),
			'news'          => esc_html__( 'Community Blog/News Site', 'gohigh-seo' ),
			'portfolio'     => esc_html__( 'Personal Portfolio', 'gohigh-seo' ),
			'business'      => esc_html__( 'Small Business Site', 'gohigh-seo' ),
			'webshop'       => esc_html__( 'Webshop', 'gohigh-seo' ),
			'otherpersonal' => esc_html__( 'Other Personal Website', 'gohigh-seo' ),
			'otherbusiness' => esc_html__( 'Other Business Website', 'gohigh-seo' ),
		];
	}
}
