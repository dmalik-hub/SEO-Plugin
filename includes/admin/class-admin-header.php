...
class Admin_Header {
	...
	public function display( $show_breadcrumbs ) {
		...
		<div class="rank-math-header">
			...
			<a href="<?php echo esc_url( $this->get_help_link() ); ?>" title="<?php esc_attr_e( 'Rank Math Knowledge Base', 'gohigh-seo' ); ?>" target="_blank" class="button rank-math-help"><i class="dashicons dashicons-editor-help"></i></a>
		</div>
		<?php
		...
		<div class="rank-math-search-options">
			<div class="components-input-control">
				<div class="components-input-control__container">
						...
						<input type="search" class="components-input-control__input" value="" placeholder="<?php esc_attr_e( 'Search Options', 'gohigh-seo' ); ?>" style="width: 100%;">
	...
	private function get_mode_selector() {
		...
		<div class="rank-math-mode-selector">
			<a href="#" class="<?php echo ! $is_advanced_mode ? 'active' : ''; ?>" data-mode="easy"><?php esc_attr_e( 'Easy Mode', 'gohigh-seo' ); ?></a>
			<a href="#" class="<?php echo $is_advanced_mode ? 'active' : ''; ?>" data-mode="advanced"><?php esc_attr_e( 'Advanced Mode', 'gohigh-seo' ); ?></a>
		</div>
		<?php
	}
