...
class WP_Schema_Pro extends Plugin_Importer {
	...
	public function get_choices() {
		return [
			'settings' => esc_html__( 'Import Settings', 'gohigh-seo' ) . Admin_Helper::get_tooltip( esc_html__( 'Plugin settings and site-wide meta data.', 'gohigh-seo' ) ),
			'postmeta' => esc_html__( 'Import Schemas', 'gohigh-seo' ) . Admin_Helper::get_tooltip( esc_html__( 'Import all Schema data for Posts, Pages, and custom post types.', 'gohigh-seo' ) ),
		];
	}
