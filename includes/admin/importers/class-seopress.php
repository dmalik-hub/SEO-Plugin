...
use GoHighSEO\Schema\JsonLD;
use GoHighSEO\Schema\Singular;
...
class SEOPress extends Plugin_Importer {
	...
	protected function settings() {
		...
		$this->titles['title_separator'] = \GoHighSEO\CMB2::sanitize_htmlentities( $seopress_titles['seopress_titles_sep'] );
	...
	private function local_seo_settings( $seopress_local ) {
		...
		$this->settings['breadcrumbs_separator'] = \GoHighSEO\CMB2::sanitize_htmlentities( $seopress_local['seopress_breadcrumbs_separator'] );
