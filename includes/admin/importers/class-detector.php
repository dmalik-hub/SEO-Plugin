...
class Detector {
	...
	public function get() {
		return $this->do_filter(
			...
			[
				'yoast'                   => [
					'class'   => '\\GoHighSEO\\Admin\\Importers\\Yoast',
					'file'    => 'wordpress-seo/wp-seo.php',
					'premium' => 'yoast-premium',
				],
				'seopress'                => [
					'class' => '\\GoHighSEO\\Admin\\Importers\\SEOPress',
					'file'  => 'wp-seopress/seopress.php',
				],
				'aioseo'                  => [
					'class'   => '\\GoHighSEO\\Admin\\Importers\\AIOSEO',
				...
				'aio-rich-snippet'        => [
					'class' => '\\GoHighSEO\\Admin\\Importers\\AIO_Rich_Snippet',
					'file'  => 'all-in-one-schemaorg-rich-snippets/index.php',
				],
				'wp-schema-pro'           => [
					'class' => '\\GoHighSEO\\Admin\\Importers\\WP_Schema_Pro',
					'file'  => 'wp-schema-pro/wp-schema-pro.php',
				],
				'redirections'            => [
					'class' => '\\GoHighSEO\\Admin\\Importers\\Redirections',
