...
use GoHighSEO\Traits\Wizard;
use GoHighSEO\Admin\Importers\Detector;
...
class Setup_Wizard {
	...
	public function add_admin_menu() {
		...
		$this->hook_suffix = add_submenu_page(
			'',
			esc_html__( 'Setup Wizard', 'gohigh-seo' ),
			esc_html__( 'Setup Wizard', 'gohigh-seo' ),
			'manage_options',
			$this->slug,
			[ $this, 'admin_page' ]
	...
	public function admin_page() {
		...
		\GoHighSEO\Tools\Update_Score::get()->enqueue();
		...
		wp_set_script_translations( 'rank-math-wizard', 'gohigh-seo' );
	...
	private static function get_steps() {
		return [
			'compatibility' => '\\GoHighSEO\\Wizard\\Compatibility',
			'import'        => '\\GoHighSEO\\Wizard\\Import',
			'yoursite'      => '\\GoHighSEO\\Wizard\\Your_Site',
			'analytics'     => '\\GoHighSEO\\Wizard\\Search_Console',
			'sitemaps'      => '\\GoHighSEO\\Wizard\\Sitemap',
			'optimization'  => '\\GoHighSEO\\Wizard\\Optimization',
			'ready'         => '\\GoHighSEO\\Wizard\\Ready',
			'role'          => '\\GoHighSEO\\Wizard\\Role',
			'redirection'   => '\\GoHighSEO\\Wizard\\Monitor_Redirection',
			'schema-markup' => '\\GoHighSEO\\Wizard\\Schema_Markup',
		];
	}
