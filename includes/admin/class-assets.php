...
class Assets implements Runner {
	...
	public function hooks() {
		...
		if ( 'elementor' === \GoHighSEO\Helpers\Param::get( 'action' ) ) {
	...
	public function register() {
		...
		Helper::add_json(
			'validationl10n',
			[
				'regexErrorDefault'    => __( 'Please use the correct format.', 'gohigh-seo' ),
				'requiredErrorDefault' => __( 'This field is required.', 'gohigh-seo' ),
				'emailErrorDefault'    => __( 'Please enter a valid email address.', 'gohigh-seo' ),
				'urlErrorDefault'      => __( 'Please enter a valid URL.', 'gohigh-seo' ),
			]
		);
	...
	public function admin_footer_text( $text ) {
		...
		return Helper::is_whitelabel() ? $text : sprintf( wp_kses_post( __( 'Thank you for using <a href="%s" target="_blank">Rank Math</a>', 'gohigh-seo' ) ), KB::get( 'seo-suite', 'Admin Footer Text' ) );
	}
	...
	public function overwrite_wplink() {
		...
		wp_localize_script(
			...
			[
				...
				'relCheckbox'       => __( 'Add <code>rel="nofollow"</code>', 'gohigh-seo' ),
				'sponsoredCheckbox' => __( 'Add <code>rel="sponsored"</code>', 'gohigh-seo' ),
