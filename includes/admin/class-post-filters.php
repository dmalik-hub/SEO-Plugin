...
class Post_Filters {
	...
	public function add_seo_filters( $options ) {
		$new_options = [
			'custom_canonical'   => __( 'Custom Canonical URL', 'gohigh-seo' ),
			'custom_title'       => __( 'Custom Meta Title', 'gohigh-seo' ),
			'custom_description' => __( 'Custom Meta Description', 'gohigh-seo' ),
		];

		if ( Helper::is_module_active( 'redirections' ) ) {
			$new_options['redirected'] = __( 'Redirected Posts', 'gohigh-seo' );
		}

		if ( Helper::is_module_active( 'link-counter' ) ) {
			$new_options['orphan'] = __( 'Orphan Posts', 'gohigh-seo' );
		}

		if ( Helper::is_module_active( 'rich-snippet' ) ) {
			$new_options['schema_type'] = __( 'Filter by Schema Type', 'gohigh-seo' );
		}
	...
	public function add_schema_filters() {
		...
		$options = [
			'none'                => esc_html__( 'Turned Off', 'gohigh-seo' ),
			...
			'PodcastEpisode'      => esc_html__( 'Podcast', 'gohigh-seo' ),
			'JobPosting'          => esc_html__( 'Job Posting', 'gohigh-seo' ),
			'MusicGroup'          => esc_html__( 'Music', 'gohigh-seo' ),
			...
			'SoftwareApplication' => esc_html__( 'Software', 'gohigh-seo' ),
			'VideoObject'         => esc_html__( 'Video', 'gohigh-seo' ),
			'Dataset'             => esc_html__( 'Dataset', 'gohigh-seo' ),
			'FAQPage'             => esc_html__( 'FAQ', 'gohigh-seo' ),
			'ClaimReview'         => esc_html__( 'FactCheck', 'gohigh-seo' ),
			'HowTo'               => esc_html__( 'How To', 'gohigh-seo' ),
		];
