...
class Quick_Edit {
	...
	public function add_tax_seo_column( $columns ) {
		$columns['rank_math_tax_seo_details'] = __( 'SEO Details', 'gohigh-seo' );
		return $columns;
	}
	...
	public function admin_scripts() {
		...
		if ( Admin_Helper::is_post_list() ) {
			wp_enqueue_script( 'gohigh-seo-post-list', RANK_MATH_PRO_URL . 'assets/admin/js/post-list.js', [], RANK_MATH_PRO_VERSION, true );
			wp_enqueue_style( 'gohigh-seo-post-list', RANK_MATH_PRO_URL . 'assets/admin/css/post-list.css', [ 'rank-math-common' ], RANK_MATH_PRO_VERSION );
		} elseif ( 'edit-tags.php' === $pagenow ) {
			wp_enqueue_script( 'gohigh-seo-term-list', RANK_MATH_PRO_URL . 'assets/admin/js/term-list.js', [], RANK_MATH_PRO_VERSION, true );
			wp_enqueue_style( 'gohigh-seo-term-list', RANK_MATH_PRO_URL . 'assets/admin/css/term-list.css', [], RANK_MATH_PRO_VERSION );
		}
	}
	...
	public function quick_edit( $column, $bulk_edit = false ) {
		...
		$robots = [
			'index'        => __( 'Index', 'gohigh-seo' ),
			'noindex'      => __( 'No Index', 'gohigh-seo' ),
			'nofollow'     => __( 'No Follow', 'gohigh-seo' ),
			'noarchive'    => __( 'No Archive', 'gohigh-seo' ),
			'noimageindex' => __( 'No Image Index', 'gohigh-seo' ),
			'nosnippet'    => __( 'No Snippet', 'gohigh-seo' ),
		];

		$edit_mode = $bulk_edit ? '_bulk' : '';
		switch ( $column ) {
			case 'rank_math_seo_details':
				wp_nonce_field( 'rank-math-quick-edit', 'rank_math_quick_edit_nonce' . $edit_mode );
				?>
				<div class="rank-math-quick-edit wp-clearfix">
					<fieldset class="inline-edit-col-left clear">
						<legend class="inline-edit-legend">
							<?php esc_html_e( 'SEO Settings', 'gohigh-seo' ); ?>
						</legend>
			...
			case 'rank_math_title':
				?>
				<label>
					<span class="title"><?php esc_html_e( 'SEO Title', 'gohigh-seo' ); ?></span>
					<span class="input-text-wrap rank-math-quick-edit-text-wrap">
						<input type="text" name="rank_math_title" id="rank_math_title<?php echo esc_attr( $edit_mode ); ?>" value="">
					</span>
				</label>
				<?php
				break;
			...
			case 'rank_math_description':
				...
				<label class="inline-edit-seo-description">
					<span class="title"><?php esc_html_e( 'SEO Description', 'gohigh-seo' ); ?></span>
					<textarea name="rank_math_description" id="rank_math_description<?php echo esc_attr( $edit_mode ); ?>"></textarea>
				</label>
				</div></fieldset>

				<fieldset class="inline-edit-col-center inline-edit-robots">
					<div class="inline-edit-col">
						<span class="title inline-edit-robots-label"><?php esc_html_e( 'Robots Meta', 'gohigh-seo' ); ?></span>
							...
							<?php foreach ( $robots as $val => $option ) : ?>
								<li id="rank_math_robots_<?php echo esc_attr( $val ); ?>" class="rank_math_robots">
									<label class="selectit">
										<input type="checkbox" name="rank_math_robots[]" id="rank_math_robots_<?php echo esc_attr( $val ); ?>_input<?php echo esc_attr( $edit_mode ); ?>" value="<?php echo esc_attr( $val ); ?>" checked="">
				...
				<fieldset class="inline-edit-col-right">
					<div class="inline-edit-col">
						<?php if ( ! $bulk_edit ) { ?>
							<label>
								<span class="title"><?php esc_html_e( 'Primary Focus Keyword', 'gohigh-seo' ); ?></span>
								<span class="input-text-wrap rank-math-quick-edit-text-wrap">
									<input type="text" name="rank_math_focus_keyword" id="rank_math_focus_keyword" value="">
								</span>
							</label>
							<label>
								<span class="title"><?php esc_html_e( 'Canonical URL', 'gohigh-seo' ); ?></span>
								<span class="input-text-wrap rank-math-quick-edit-text-wrap">
									...
									<fieldset class="inline-edit-rank-math-primary-term inline-edit-categories">
										...
										<label class="rank-math-primary-term">
											<span class="title">
												...
												<?php echo esc_html( sprintf( __( 'Primary %s', 'gohigh-seo' ), $taxonomy_obj['singularLabel'] ) ); ?>
											</span>
											<span class="input-text-wrap rank-math-quick-edit-text-wrap">
											<?php
											wp_dropdown_categories(
												[
													...
													'show_option_none' => __( '&mdash; Not Selected &mdash;', 'gohigh-seo' ),
													'option_none_value' => '0',
												]
											);
											?>
				...
				<div class="rank-math-quick-edit wp-clearfix inline-edit-row">
					<fieldset>
						...
						<div class="inline-edit-col">
							...
							<label class="inline-edit-seo-description">
								<div><?php esc_html_e( 'SEO Description', 'gohigh-seo' ); ?></div>
								<textarea name="rank_math_description" id="rank_math_description"></textarea>
							</label>

							<div class="inline-edit-robots-label"><?php esc_html_e( 'Robots Meta', 'gohigh-seo' ); ?></div>
							<ul class="cat-checklist category-checklist rank-math-robots-checklist">
								<?php foreach ( $robots as $val => $option ) : ?>
									<li id="rank_math_robots_<?php echo esc_attr( $val ); ?>" class="rank_math_robots">
										<label class="selectit">
							...
							<label class="clear">
								<div class="title"><?php esc_html_e( 'Primary Focus Keyword', 'gohigh-seo' ); ?></div>
								<div class="rank-math-quick-edit-text-wrap">
									<input type="text" name="rank_math_focus_keyword" id="rank_math_focus_keyword" value="">
								</div>
							</label>
							<label class="clear">
								<div class="title"><?php esc_html_e( 'Canonical URL', 'gohigh-seo' ); ?></div>
	...
	public function determine_search_intent( $keyword ) {
		...
		$intent_types   = [
			'commercial'    => esc_html__( 'Commercial', 'gohigh-seo' ),
			'informational' => esc_html__( 'Informational', 'gohigh-seo' ),
			'navigational'  => esc_html__( 'Navigational', 'gohigh-seo' ),
			'transactional' => esc_html__( 'Transactional', 'gohigh-seo' ),
		];
