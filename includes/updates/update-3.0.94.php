 ...
 */
function rank_math_3_0_94_update_news_sitemap_exclude_terms_format() {
	if ( Helper::is_module_active( 'news-sitemap' ) ) {
		\GoHighSEO\Sitemap\News_Sitemap\Admin::format_news_sitemap_exclude_terms( 'react-settings', 'on' );
	}
}

rank_math_3_0_94_update_news_sitemap_exclude_terms_format();
