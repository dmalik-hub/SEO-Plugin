 ...
 */
function rank_math_3_0_72_migrate_gtin() {
	...
	Helper::add_notification(
		...
		__( 'The GTIN values from the plugin are being transferred to the built-in WooCommerce GTIN field. This process runs in the background, and you\'ll receive a confirmation message once all product data has been successfully migrated. You can close this page.', 'gohigh-seo' ),
		[
			'type'    => 'success',
